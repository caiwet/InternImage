...
#SBATCH -o bash_output/ranzcr-pretrained-mimic02%j.out                          # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e bash_output/ranzcr-pretrained-mimic02%j.err                          # File to which STDERR will be written, including job ID (%j)
